...
\begin{center}
\leavevmode
\includegraphics[width=291pt]{bdd_8c__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Retourne la liste des cartes pouvant attaquer la carte {\ttfamily c} \end{DoxyCompactList}\end{DoxyCompactItemize}
